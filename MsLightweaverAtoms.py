...
def H_6_prd():
    ...
    lines=[
        VoigtLine(j=1, i=0, f=4.167000e-01, type=LineType.PRD, quadrature=LinearCoreExpWings(Nlambda=200, qCore=100.000000, qWing=600.000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=4.702e8)], elastic=[VdwRadyn(vals=[1.0]), HydrogenLinearStarkBroadening()])),
...
def CaII():
    ...
    lines=[
        VoigtLine(j=3, i=0, f=3.16e-01, type=LineType.PRD, quadrature=LinearCoreExpWings(Nlambda= 150, qCore=30.000000, qWing=1500.00000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=1.42e+08)], elastic=[MultiplicativeStarkBroadening(5.458e-7*Const.CM_TO_M**3), VdwRadyn(vals=[1.62])])),
        VoigtLine(j=4, i=0, f=6.37e-01, type=LineType.PRD, quadrature=LinearCoreExpWings(Nlambda= 150, qCore=30.000000, qWing=1500.00000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=1.46e+08)], elastic=[MultiplicativeStarkBroadening(5.410e-7*Const.CM_TO_M**3), VdwRadyn(vals=[1.61])])),
...
def CaII_prd():
    ...
    lines=[
        VoigtLine(j=3, i=0, f=3.16e-01, type=LineType.PRD, quadrature=LinearCoreExpWings(Nlambda= 120, qCore=30.000000, qWing=1500.00000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=1.42e+08)], elastic=[MultiplicativeStarkBroadening(5.458e-7*Const.CM_TO_M**3), VdwRadyn(vals=[1.62])])),
        VoigtLine(j=4, i=0, f=6.37e-01, type=LineType.PRD, quadrature=LinearCoreExpWings(Nlambda= 120, qCore=30.000000, qWing=1500.00000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=1.46e+08)], elastic=[MultiplicativeStarkBroadening(5.410e-7*Const.CM_TO_M**3), VdwRadyn(vals=[1.61])])),
        VoigtLine(j=3, i=1, f=4.73e-02, type=LineType.CRD, quadrature=LinearCoreExpWings(Nlambda= 80, qCore=10.000000, qWing=200.000000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=1.42e+08)], elastic=[MultiplicativeStarkBroadening(2.673e-7*Const.CM_TO_M**3), VdwRadyn(vals=[2.04])])),
        VoigtLine(j=4, i=1, f=9.60e-03, type=LineType.CRD, quadrature=LinearCoreExpWings(Nlambda= 80, qCore=10.000000, qWing=150.000000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=1.46e+08)], elastic=[MultiplicativeStarkBroadening(3.000e-6*Const.CM_TO_M**3), VdwRadyn(vals=[2.01])])),
        VoigtLine(j=4, i=2, f=5.74e-02, type=LineType.CRD, quadrature=LinearCoreExpWings(Nlambda=100, qCore=10.000000, qWing=200.000000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=1.46e+08)], elastic=[MultiplicativeStarkBroadening(3.000e-6*Const.CM_TO_M**3), VdwRadyn(vals=[2.01])])),
    ],
