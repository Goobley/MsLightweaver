...
def H_6_prd():
    ...
    lines=[
        VoigtLine(j=1, i=0, f=4.167000e-01, type=LineType.PRD, quadrature=LinearCoreExpWings(Nlambda=150, qCore=40.000000, qWing=600.000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=4.702e8)], elastic=[VdwRadyn(vals=[1.0]), HydrogenLinearStarkBroadening()])),
        VoigtLine(j=2, i=0, f=7.919000e-02, type=LineType.PRD, quadrature=LinearCoreExpWings(Nlambda=150, qCore=40.000000, qWing=250.000), broadening=LineBroadening(natural=[RadiativeBroadening(gamma=9.991e7)], elastic=[VdwRadyn(vals=[1.0]), HydrogenLinearStarkBroadening()])),
